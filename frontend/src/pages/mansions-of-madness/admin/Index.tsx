...
import { AdminField } from "@/components/mansions-of-madness/admin/Field"
import { joinAdminGame } from "@/api/game"

export default function MOMAdmin() {
    ...
    useEffect(() => {
        ...
        const joinGame = async () => {
            const { data } = await joinAdminGame('mansions_of_madness');
